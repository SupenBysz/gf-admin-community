...
func (c *cSysLicense) GetLicenseById(ctx context.Context, req *sys_api.GetLicenseByIdReq) (*sys_model.PersonLicenseRes, error) {
	// 权限判断
	...
	return (*sys_model.PersonLicenseRes)(result), err
}

// QueryLicenseList 查询个人认证|列表
func (c *cSysLicense) QueryLicenseList(ctx context.Context, req *sys_api.QueryLicenseListReq) (*sys_model.PersonLicenseListRes, error) {
	ret := sys_model.PersonLicenseListRes{Records: make([]sys_entity.SysPersonLicense, 0)}
...
// func (c *cSysLicense) CreateLicense(ctx context.Context, req *sys_api.CreateLicenseReq) (*sys_model.PersonLicenseRes, error) {
//	result, err := sys_service.SysPersonLicense().CreateLicense(ctx, req.License, req.OperatorId)
//	return (*sys_model.PersonLicenseRes)(result), err
// }

// // UpdateLicense 更新个人资质|信息
// func (c *cSysLicense) UpdateLicense(ctx context.Context, req *sys_api.UpdateLicenseReq) (*sys_model.PersonLicenseRes, error) {
