...
require (
	...
	github.com/kysion/oss-library v0.2.11
	github.com/kysion/sms-library v0.2.12
...
require (
	...
	github.com/tencentcloud/tencentcloud-sdk-go/tencentcloud/cvm v1.0.1144 // indirect
