...
type QueryUserListReq struct {
	g.Meta `path:"/queryUserList?cp=5947176286288325" method:"post" summary:"获取用户|列表" tags:"用户"`
	sys_model.SearchParams
	PermissionId string `json:"permissionId" description:"接口权限ID" default:""`
}

type SetUserRoleIdsReq struct {
	g.Meta  `path:"/setUserRoleIds?cp=5949854362632264" method:"post" summary:"设置用户角色" tags:"用户"`
...
type SetUserPermissionIdsReq struct {
	g.Meta        `path:"/setUserPermissionIds?cp=5949854362632262" method:"post" summary:"设置用户权限" tags:"用户"`
...
type ResetUserPasswordReq struct {
	g.Meta          `path:"/resetUserPasswordReq?cp=5947177123969477" method:"post" summary:"重置用户密码" tags:"用户"`
