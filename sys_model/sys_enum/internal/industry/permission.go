...
var PermissionType = permissionType{
	ViewDetail: permission.New(5948649434489932, "ViewDetail", "查看行业类别", "查看某个行业类别"),
	Tree:       permission.New(5948649530309933, "Tree", "行业类别树", "查看行业类别树"),
	Update:     permission.New(5948649642789934, "Update", "更新行业类别", "更新某个行业类别"),
	Delete:     permission.New(5948649739509935, "Delete", "删除行业类别", "删除某个行业类别"),
	Create:     permission.New(5948649828769936, "Create", "创建行业类别", "创建行业类别"),
}
